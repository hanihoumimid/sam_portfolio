        ...
        <div className="container relative flex flex-col items-center justify-between px-6 py-4 mx-auto">
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center justify-center mt-8">
              <a 
                href="#contact" 
                className="px-6 py-3 text-gray-800 uppercase bg-transparent border-2 border-gray-800 dark:text-gray-800 dark:bg-white hover:dark:bg-gray-100 dark:text-white hover:bg-gray-800 hover:text-white text-md transition-colors duration-300"
              >
                CONNECT WITH ME
              </a>
            </div>
